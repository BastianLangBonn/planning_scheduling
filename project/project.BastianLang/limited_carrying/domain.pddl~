(define (domain domain)
	...
	(:action pick
		...
		:precondition 	(and (gripper_free) (robot_at ?s) (at_location ?o ?s) (not(part_of_line ?o))(carries_none)
				)
		:effect 	(and (not (gripper_free)) (not (at_location ?o ?s)) (grapped ?o)
				(when (carries_two)(and(carries_three)(not(carries_two))))
				(when (carries_one)(and(carries_two)(not(carries_one))))
				(when (carries_none)(and(carries_one)(not(carries_none))))			
				)
	)
	(:action place
		:parameters 	(?o - object ?s - station)
		...
		:effect 	(and (gripper_free) (at_location ?o ?s) (not (grapped ?o))
				(when (carries_one)(and(carries_none)(not(carries_one))))
				(when (carries_two)(and(carries_one)(not(carries_two))))
				(when (carries_three)(and(carries_two)(not(carries_three))))			
				)
	)
