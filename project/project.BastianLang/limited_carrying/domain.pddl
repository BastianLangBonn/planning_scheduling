(define (domain domain)
	...
	(:action place
		:parameters 	(?r - robot ?o - item ?s - station ?c2 ?c1 - capacity)
	...
	(:action align_with_object
		:parameters 	(?r - robot ?o ?o_new - item ?s - station ?c2 ?c1 - capacity)
		:precondition 	(and 
				(at_location ?r ?s) 
				(at_location ?o ?s) 
				(grapped ?r ?o_new) 
	...
	(:action add_to_line
		:parameters 	(?r - robot ?o1 ?o2 ?o_new - item ?s - station ?c2 ?c1 - capacity)
		:precondition	(and 
				(at_location ?r ?s) 
				(grapped ?r ?o_new) 
				(at_location ?o1 ?s) 
